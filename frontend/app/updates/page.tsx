...
export default async function UpdatesPage() {
  ...
  return <main className="page py-12 md:py-16"><p className="eyebrow">Change log</p><h1 className="mt-3 text-4xl font-bold">更新履歴</h1><p className="mt-4 text-[#5b6e6c]">取得データの変化を、新しいものから表示します。</p><div className="mt-8"><DevelopmentNotice /></div>
