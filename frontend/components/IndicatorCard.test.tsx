...
describe("IndicatorCard", () => {
  it("shows the value, period, source navigation and change", () => {
    render(<IndicatorCard indicator={{
      ...
      latest: { value: "12360.000000", period: "2024年（開発用）", publishedAt: "2025-01-31", fetchedAt: "2025-01-31T00:00:00Z", sourceUrl: "https://example.test", origin: "development", estimateKind: "development" },
      previous: { value: "12410.000000", period: "2023年", publishedAt: "2024-01-31", fetchedAt: "2024-01-31T00:00:00Z", sourceUrl: "https://example.test", origin: "development", estimateKind: "development" }, change: "-50.000000",
    }} />);
